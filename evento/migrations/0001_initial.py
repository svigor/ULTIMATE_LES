    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numero_telefone', models.CharField(blank=True, db_column='Numero telefone', max_length=255, null=True)),
                ('interno', models.TextField(blank=True, db_column='Interno', null=True)),
                ('password', models.CharField(db_column='Password', max_length=255)),
                ('username', models.CharField(blank=True, db_column='UserName', max_length=255, null=True)),
                ('notificacoesid', models.ForeignKey(db_column='NotificacoesID', on_delete=django.db.models.deletion.DO_NOTHING, to='evento.notificacoes')),
            ],
            options={
                'db_table': 'utilizador',
                'managed': True,
        ...
        migrations.CreateModel(
            name='Admin',
            fields=[
                ('utilizadorid', models.OneToOneField(db_column='UtilizadorID', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='evento.utilizador')),
            ],
            options={
                'db_table': 'admin',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(blank=True, db_column='Nome', max_length=255, null=True)),
                ('mobilidade_reduzida', models.BooleanField(db_column='Mobilidade reduzida', default=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='ParticipanteUtilizadorID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='evento.participante'),
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('eventoid', models.ForeignKey(db_column='EventoID', on_delete=django.db.models.deletion.DO_NOTHING, to='evento.evento')),
                ('participanteutilizadorid', models.ForeignKey(blank=True, db_column='ParticipanteUtilizadorID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='evento.participante')),
            ],
            options={
                'db_table': 'feedback',
                'managed': True,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='ProponenteUtilizadorID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='evento.proponente'),
        ),
    ]
