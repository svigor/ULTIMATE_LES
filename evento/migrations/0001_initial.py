    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participanteutilizadorid', models.ForeignKey(blank=True, db_column='ParticipanteUtilizadorID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='utilizadores.participante')),
            ],
            options={
                'db_table': 'inscricao',
                'managed': True,
