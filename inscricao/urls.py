...
urlpatterns = [
    ...
    path('inscricao-no-meu-recursos/<int:id>', views.viewInscricaoporValidar, name='viewinscricaomeuevento'),
    ...
    path('inscricao-no-meu-recursos-validada/<int:id>/', views.viewinscricaoValidadas, name='inscricaovalidadas'),
